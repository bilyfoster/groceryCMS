...
```
src/main/java/com/onelpro/gayphxapi/
│
...
```java
package com.onelpro.gayphxapi.models;

import com.onelpro.gayphxapi.enums.UserStatus;
import jakarta.persistence.*;
...
```java
package com.onelpro.gayphxapi.dto;
...
### Database Changes
- ✅ **Liquibase Changeset**: Create a new XML changeset file in `gayphx-api-liquibase/src/main/resources/db/changelog/`
